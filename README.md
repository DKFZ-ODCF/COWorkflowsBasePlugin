...
|allowSampleTerminationWithIndex          |true     | Allow recognition of trailing integer numbers (or "index") for sample names, e.g. tumor_02, if tumor is set. |
...
If you want to emulate with version_2 a similar strategy like version_1 implements, you can do that by setting
```bash
